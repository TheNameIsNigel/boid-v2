...
class Regex {
     ...
     */
    public static Pattern TOP_LEVEL_DOMAIN_PATTERN
            = Pattern.compile(
     ...
     * This pattern is auto-generated by //device/tools/make-iana-tld-pattern.py
     */
    public static Pattern WEB_URL_PATTERN
            = Pattern.compile(
    ...
    public static Pattern IP_ADDRESS_PATTERN
            = Pattern.compile(
    ...
    public static Pattern EMAIL_ADDRESS_PATTERN
            = Pattern.compile(
            "[a-zA-Z0-9\\+\\.\\_\\%\\-]{1,256}" +
                    "\\@" +
